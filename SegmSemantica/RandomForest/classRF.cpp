...
double unif_rand(){
	uint32 a = randomMT();
	a = a == MAX_UINT_COKUS ? MAX_UINT_COKUS - 1 : a;
	return (((double)a) / ((double)MAX_UINT_COKUS));
}
...
void classRF(double *x, int *dimx, int *cl, int *ncl, int *cat, int *maxcat,
	...
	******************************************************************/
	...
	//frees up the memory
	delete[] tgini; delete[] wl; delete[] wr; delete[] classpop; delete[] tclasscat;
	delete[] tclasspop; delete[] tx; delete[] win; delete[] tp; delete[] out;
	delete[] bestsplitnext; delete[] bestsplit; delete[] nodepop; delete[] nodestart; delete[] jin;
	delete[] nodex; delete[] nodexts; delete[] ta; delete[] ncase; delete[] jerr;
	delete[] varUsed; delete[] jtr; delete[] jvr; delete[] classFreq; delete[] jts;
	delete[] idmove; delete[] at; delete[] a; delete[] b; delete[] mind;
	delete[] nright; delete[] nrightimp; delete[] nout;
